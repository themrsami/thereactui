...
const Button = require$$0.forwardRef(({ variant = 'secondary', size = 'md', loading = false, className = '', children, disabled, ...props }, ref) => {
    ...
    return (require$$1.jsxs("button", { ref: ref, className: combinedClassName, disabled: disabled || loading, ...props, children: [loading && (require$$1.jsx("span", { className: `mr-2 h-3 w-3 animate-spin border ${variant === 'primary'
...
function ButtonGroup({ children, orientation = 'horizontal', className = '' }) {
    ...
    return (require$$1.jsx("div", { className: combinedClassName, role: "group", children: processedChildren }));
}
...
function CopyButton({ text, variant = 'ghost', size = 'sm', className = '', iconOnly = false }) {
    ...
    return (require$$1.jsx(Button, { variant: variant, size: size, onClick: handleCopy, className: `flex items-center gap-1 ${className}`, disabled: copied, children: copied ? (require$$1.jsxs(require$$1.Fragment, { children: [require$$1.jsx(lucideReact.Check, { size: 14 }), !iconOnly && 'Copied!'] })) : (require$$1.jsxs(require$$1.Fragment, { children: [require$$1.jsx(lucideReact.Copy, { size: 14 }), !iconOnly && 'Copy'] })) }));
}

const IconButton = require$$0.forwardRef(({ variant = 'secondary', size = 'md', loading = false, className = '', children, disabled, 'aria-label': ariaLabel, ...props }, ref) => {
    // Base styles - theReactUI principles: no border-radius, pure black/white
    const baseStyles = 'inline-flex items-center justify-center font-medium transition-transform duration-100 ease-in-out transform focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-current disabled:opacity-50 disabled:pointer-events-none active:translate-y-[1px] active:scale-[0.98]';
    // Variant styles - following theReactUI design: borders only, no backgrounds
    const variantStyles = {
    ...
    return (require$$1.jsx("button", { ref: ref, className: combinedClassName, disabled: disabled || loading, "aria-label": ariaLabel, ...props, children: loading ? (require$$1.jsx("span", { className: `h-3 w-3 animate-spin border ${variant === 'primary'
                ? 'border-background border-t-transparent'
                : 'border-current border-t-transparent'}` })) : (children) }));
});
IconButton.displayName = 'IconButton';

const Input = require$$0.forwardRef(({ className = '', variant = 'default', size = 'md', error = false, helperText, errorMessage, label, labelHidden = false, id, ...props }, ref) => {
    ...
    return (require$$1.jsxs("div", { className: "w-full", children: [label && (require$$1.jsx("label", { htmlFor: inputId, className: `
              block text-sm font-medium text-foreground mb-2
              ${labelHidden ? 'sr-only' : ''}
            `.trim().replace(/\s+/g, ' '), children: label })), require$$1.jsx("input", { ref: ref, id: inputId, className: finalClassName, ...props }), (helperText || errorMessage) && (require$$1.jsx("p", { className: `
            mt-2 text-sm
...
function CodeBlock({ children, language = 'typescript', filename, className = '' }) {
    ...
    return (require$$1.jsxs("div", { className: `code-window ${className}`, children: [filename && (require$$1.jsxs("div", { className: "code-window-header flex items-center justify-between", children: [require$$1.jsx("span", { children: filename }), require$$1.jsx(CopyButton, { text: children })] })), require$$1.jsxs("div", { className: "code-window-content relative", children: [!filename && (require$$1.jsx("div", { className: "absolute top-2 right-2", children: require$$1.jsx(CopyButton, { text: children }) })), require$$1.jsx("pre", { children: require$$1.jsx("code", { ref: codeRef, className: `language-${language}`, children: children }) })] })] }));
}
...
function Breadcrumb({ items, className = '' }) {
    return (require$$1.jsx("nav", { className: `flex items-center space-x-1 text-sm ${className}`, "aria-label": "Breadcrumb", children: items.map((item, index) => (require$$1.jsxs("div", { className: "flex items-center", children: [index > 0 && require$$1.jsx(lucideReact.ChevronRight, { size: 14, className: "mx-1 opacity-50" }), item.href && index < items.length - 1 ? (require$$1.jsx(Link, { href: item.href, className: "hover:underline opacity-70 hover:opacity-100 transition-opacity cursor-pointer", children: item.label })) : (require$$1.jsx("span", { className: index === items.length - 1 ? 'font-medium' : 'opacity-70', children: item.label }))] }, index))) }));
}
...
const Modal = ({ isOpen, onClose, title, children, size = 'md', closeOnBackdropClick = true, closeOnEsc = true, className = '', overlayClassName = '' }) => {
    ...
    const previousFocusRef = require$$0.useRef(null);
    ...
    return reactDom.createPortal(require$$1.jsxs("div", { className: `fixed inset-0 z-50 flex items-center justify-center p-4 ${overlayClassName}`, onClick: handleBackdropClick, role: "dialog", "aria-modal": "true", "aria-labelledby": title ? 'modal-title' : undefined, children: [require$$1.jsx("div", { className: "fixed inset-0 bg-black/30 dark:bg-white/20" }), require$$1.jsxs("div", { ref: modalRef, className: `relative w-full ${sizeClasses[size]} bg-background text-foreground border border-foreground max-h-[90vh] overflow-auto shadow-lg ${className}`, onClick: (e) => e.stopPropagation(), onKeyDown: handleKeyDown, tabIndex: -1, style: { zIndex: 1000 }, children: [(require$$1.jsxs("div", { className: "flex items-center justify-between p-6 border-b border-foreground text-foreground", children: [title && (require$$1.jsx("h2", { id: "modal-title", className: "text-xl font-semibold text-foreground", children: title })), require$$1.jsx("button", { onClick: onClose, className: "ml-auto p-1 text-foreground hover:bg-foreground hover:text-background transition-colors", "aria-label": "Close modal", children: require$$1.jsx(lucideReact.X, { size: 20 }) })] })), require$$1.jsx("div", { className: "p-6 text-foreground", children: children })] })] }), document.body);
};

const Card = require$$0.forwardRef(({ children, className = '', variant = 'default', padding = 'md', onClick, hoverable = false, ...props }, ref) => {
    // Variant classes
    const variantClasses = {
    ...
    `.trim().replace(/\s+/g, ' ');
    const finalClassName = `${baseClasses} ${className}`;
    return (require$$1.jsx("div", { ref: ref, className: finalClassName, onClick: onClick, ...props, children: children }));
});
const CardHeader = require$$0.forwardRef(({ children, className = '', ...props }, ref) => {
    const baseClasses = 'border-b border-current pb-3 mb-3';
    const finalClassName = `${baseClasses} ${className}`;
    return (require$$1.jsx("div", { ref: ref, className: finalClassName, ...props, children: children }));
});
const CardContent = require$$0.forwardRef(({ children, className = '', ...props }, ref) => {
    const baseClasses = 'text-foreground';
    const finalClassName = `${baseClasses} ${className}`;
    return (require$$1.jsx("div", { ref: ref, className: finalClassName, ...props, children: children }));
});
const CardFooter = require$$0.forwardRef(({ children, className = '', ...props }, ref) => {
...
const Badge = require$$0.forwardRef(({ children, variant = 'default', size = 'md', className = '', outline = false, ...props }, ref) => {
    // Size classes
    const sizeClasses = {
    ...
    `.trim().replace(/\s+/g, ' ');
    const finalClassName = `${baseClasses} ${className}`;
    return (require$$1.jsx("span", { ref: ref, className: finalClassName, ...props, children: children }));
});
...
const Tooltip = ({ children, content, placement = 'top', delay = 200, className = '', disabled = false, arrow = true, ...props }) => {
    ...
    const [isPositioned, setIsPositioned] = require$$0.useState(false);
    ...
    const triggerElement = require$$0.isValidElement(children)
        ? require$$0.cloneElement(children, {
            ref: (node) => {
    ...
    if (!isVisible || typeof window === 'undefined') {
        return require$$1.jsx(require$$1.Fragment, { children: triggerElement });
    }
    return (require$$1.jsxs(require$$1.Fragment, { children: [triggerElement, reactDom.createPortal(require$$1.jsx("div", { ref: tooltipRef, className: `fixed z-50 px-2 py-1 text-sm bg-foreground text-background border border-current pointer-events-none ${className}`, style: {
...
const TheReactUIContext = require$$0.createContext({});
const useTheReactUI = () => {
    const context = require$$0.useContext(TheReactUIContext);
    if (!context) {
...
function TheReactUIProvider({ children, ...props }) {
    return (require$$1.jsx(nextThemes.ThemeProvider, { attribute: "class", defaultTheme: "light", enableSystem: true, disableTransitionOnChange: true, ...props, children: require$$1.jsx(TheReactUIContext.Provider, { value: {}, children: children }) }));
}
...
const navigation = [
    {
        ...
        href: '/docs',
        icon: require$$1.jsx(lucideReact.Book, { size: 16 }),
    },
    {
        title: 'Installation',
        href: '/installation',
        icon: require$$1.jsx(lucideReact.Download, { size: 16 }),
    },
    {
        title: 'Components',
        href: '/components',
        icon: require$$1.jsx(lucideReact.Layers, { size: 16 }),
        items: [
...
function ThemeDropdown({ theme, setTheme }) {
    ...
    const themes = [
        { value: 'light', label: 'Light', icon: require$$1.jsx(lucideReact.Sun, { size: 14 }) },
        { value: 'dark', label: 'Dark', icon: require$$1.jsx(lucideReact.Moon, { size: 14 }) },
        { value: 'system', label: 'System', icon: require$$1.jsx(lucideReact.Monitor, { size: 14 }) },
    ];
    const currentTheme = themes.find(t => t.value === theme) || themes[0];
    return (require$$1.jsxs("div", { className: "relative", children: [require$$1.jsxs(Button, { variant: "ghost", size: "sm", onClick: () => setIsOpen(!isOpen), className: "navbar-theme-button relative flex items-center gap-2 cursor-pointer", children: [currentTheme.icon, require$$1.jsx(lucideReact.ChevronDown, { size: 12 })] }), isOpen && (require$$1.jsx("div", { className: "absolute right-0 mt-1 w-28 border border-background bg-background z-50 shadow-sm", children: themes.map((themeOption) => (require$$1.jsxs("button", { className: "w-full px-3 py-2 text-left text-sm hover:bg-foreground hover:text-background flex items-center gap-2 bg-background text-foreground border-none cursor-pointer", onClick: () => {
                        setTheme(themeOption.value);
                        setIsOpen(false);
                    }, children: [themeOption.icon, themeOption.label] }, themeOption.value))) })), isOpen && (require$$1.jsx("div", { className: "fixed inset-0 z-40", onClick: () => setIsOpen(false) }))] }));
}
function Sidebar({ navigation, pathname, isOpen, onClose }) {
    const [expandedItems, setExpandedItems] = require$$0.useState(['Components']);
    ...
    return (require$$1.jsx("aside", { className: `fixed left-0 top-16 w-64 h-[calc(100vh-4rem)] border-r border-current overflow-y-auto bg-foreground z-40 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`, children: require$$1.jsxs("div", { className: "p-4", children: [require$$1.jsx("div", { className: "flex justify-end lg:hidden mb-4", children: require$$1.jsx(Button, { variant: "ghost", size: "sm", onClick: onClose, className: "text-background hover:bg-background hover:text-foreground", children: require$$1.jsx(lucideReact.X, { size: 16 }) }) }), require$$1.jsxs("div", { className: "relative mb-4", children: [require$$1.jsx(lucideReact.Search, { size: 16, className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-background opacity-70" }), require$$1.jsx("input", { type: "text", placeholder: "Search components...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "w-full pl-10 pr-3 py-2 bg-transparent text-background border border-background placeholder:text-background placeholder:opacity-80 placeholder:text-xs focus:outline-none focus:ring-2 focus:ring-background focus:border-background" })] }), require$$1.jsx("nav", { className: "space-y-2", children: filteredNavigation.map((item) => (require$$1.jsx("div", { children: item.items ? (
                        // Dropdown item
                        require$$1.jsxs("div", { children: [require$$1.jsxs("button", { onClick: () => toggleExpanded(item.title), className: `w-full flex items-center justify-between px-3 py-2 text-sm font-medium border cursor-pointer ${pathname === item.href
                                        ? 'bg-background text-foreground border-background'
                                        : 'text-background border-transparent hover:border-background'}`, children: [require$$1.jsxs("div", { className: "flex items-center gap-2", children: [item.icon, item.title] }), isExpanded(item.title) ?
                                            require$$1.jsx(lucideReact.ChevronDown, { size: 14 }) :
                                            require$$1.jsx(lucideReact.ChevronRight, { size: 14 })] }), isExpanded(item.title) && (require$$1.jsx("div", { className: "ml-4 mt-1 space-y-1", children: item.items.map((subItem) => (require$$1.jsx(Link, { href: subItem.href, className: `block px-3 py-1 text-sm border cursor-pointer ${pathname === subItem.href
                                            ? 'bg-background text-foreground border-background'
                                            : 'text-background border-transparent hover:border-background'}`, children: subItem.title }, subItem.href))) }))] })) : (
                        // Regular item
                        require$$1.jsxs(Link, { href: item.href, className: `flex items-center gap-2 px-3 py-2 text-sm font-medium border cursor-pointer ${pathname === item.href
                                ? 'bg-background text-foreground border-background'
...
function DocLayout({ children }) {
    ...
    const [isSidebarOpen, setIsSidebarOpen] = require$$0.useState(false);
    ...
    return (require$$1.jsxs("div", { className: "min-h-screen", children: [require$$1.jsx("header", { className: "fixed top-0 left-0 right-0 h-16 border-b border-current bg-foreground z-50", children: require$$1.jsxs("div", { className: "flex items-center justify-between h-full px-6", children: [require$$1.jsxs("div", { className: "flex items-center gap-4", children: [require$$1.jsx(Button, { variant: "ghost", size: "sm", onClick: () => setIsSidebarOpen(!isSidebarOpen), className: "lg:hidden text-background hover:bg-background hover:text-foreground", children: require$$1.jsx(lucideReact.Menu, { size: 16 }) }), require$$1.jsx(Link, { href: "/", className: "text-xl font-bold text-background cursor-pointer", children: "theReactUI" })] }), require$$1.jsx(ThemeDropdown, { theme: theme, setTheme: setTheme })] }) }), isSidebarOpen && (require$$1.jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 z-30 lg:hidden", onClick: () => setIsSidebarOpen(false) })), require$$1.jsx(Sidebar, { navigation: navigation, pathname: pathname, isOpen: isSidebarOpen, onClose: () => setIsSidebarOpen(false) }), require$$1.jsx("main", { className: "lg:ml-64 pt-16", children: require$$1.jsxs("div", { className: "max-w-4xl mx-auto p-8", children: [require$$1.jsx(Breadcrumb, { items: generateBreadcrumbs(), className: "mb-6" }), children] }) })] }));
}
...
exports.Input = Input;
exports.Modal = Modal;
exports.TheReactUIProvider = TheReactUIProvider;
exports.Tooltip = Tooltip;
exports.useTheReactUI = useTheReactUI;
