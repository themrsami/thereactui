...
const Button = forwardRef((_a, ref) => {
    var { variant = 'secondary', size = 'md', loading = false, className = '', children, disabled } = _a, props = __rest(_a, ["variant", "size", "loading", "className", "children", "disabled"]);
    ...
    return (<button ref={ref} className={combinedClassName} disabled={disabled || loading} {...props}>
        {loading && (<span className={`mr-2 h-3 w-3 animate-spin border ${variant === 'primary'
