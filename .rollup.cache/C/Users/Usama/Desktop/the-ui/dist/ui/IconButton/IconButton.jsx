...
const IconButton = forwardRef((_a, ref) => {
    var { variant = 'secondary', size = 'md', loading = false, className = '', children, disabled, 'aria-label': ariaLabel } = _a, props = __rest(_a, ["variant", "size", "loading", "className", "children", "disabled", 'aria-label']);
    ...
    return (<button ref={ref} className={combinedClassName} disabled={disabled || loading} aria-label={ariaLabel} {...props}>
        {loading ? (<span className={`h-3 w-3 animate-spin border ${variant === 'primary'
